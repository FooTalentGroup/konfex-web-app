...
clienteRoutes.post("/", validationSchema(createClienteSchema), createClienteController);

clienteRoutes.put("/:id", validationSchema(updateClienteSchema), updateClienteController);
