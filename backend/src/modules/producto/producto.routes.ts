...
import { createProductoSchema, productoQuerySchema, updateProductoSchema } from "./producto.schema";

export const productoRoutes = Router();

productoRoutes.get("/", getAllProductosController);
productoRoutes.get("/search", validationSchema(productoQuerySchema), searchProductosController);
