  ...
  ${hasError ? 'focus:border-[#D9537A]' : 'focus:border-[#B65CF2]'} w-full ${className}`}
        ...
        {isPassword && showPasswordToggle && (
          <button
            ...
            className={`absolute right-3 top-1/2 transform -translate-y-1/2 hover:opacity-80 focus:outline-none flex items-center justify-center ${hasError ? 'text-[#D9537A]' : 'text-gray-400'
              }`}
