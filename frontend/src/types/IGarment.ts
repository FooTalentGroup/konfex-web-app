...
export const GarmentSchema = z.object({
    ...
    commercialName: z
        ...
        .refine((val) => textOnlyRegex.test(val), {
            message:
                'El nombre comercial solo puede contener letras, espacios, comas y guiones',
        }),
    ...
    sizes: z.array(z.string()).min(1, 'Las tallas son requeridas'),
    colors: z.array(z.string()).min(1, 'Los colores son requeridos'),
    ...
    wasteMaterial: z
        .number({ error: 'La merma debe ser un número' })
        .min(0, 'La merma debe ser mayor o igual a 0')
        .optional(),
