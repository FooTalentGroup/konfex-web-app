...
import { BudgetDetailData } from "@/components/budgets/BudgetDetailCard";
import { BudgetItem } from "@/components/budgets/BudgetItemsTable";
...
/**
 * Mapea un BudgetResponseDto a BudgetDetailData
 */
export const mapPresupuestoToBudgetDetail = (
  ...
  return {
    id: formatBudgetNumber(presupuesto.numeroPresupuesto),
